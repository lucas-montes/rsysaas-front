...
<section class="p-6 my-6 my-20">
	<div class="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
		<div
			class="flex p-4 border border-white space-x-4 rounded-lg md:space-x-6 dark:bg-black dark:text-white"
		>
			<div class="flex justify-center p-2 align-middle rounded-lg sm:p-4 dark:bg-white">
				<svg
					xmlns="http://www.w3.org/2000/svg"
					viewBox="0 0 512 512"
					fill="currentColor"
					class="h-9 w-9 dark:text-black"
				>
					<polygon
			...
			<div class="flex flex-col justify-center align-middle">
				<p class="text-3xl font-semibold leadi">{$LL.utilityStatsUptimeValue()}</p>
				<p class="capitalize">{$LL.utilityStatsUptime()}</p>
			</div>
		</div>
		<div
			class="border border-white flex p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-black dark:text-white"
		>
			<div class="flex justify-center p-2 align-middle rounded-lg sm:p-4 dark:bg-white">
				<svg
					xmlns="http://www.w3.org/2000/svg"
			...
			<div class="flex flex-col justify-center align-middle">
				<p class="text-3xl font-semibold leadi">{$LL.utilityStatsOrdersIncreaseValue()}</p>
				<p class="capitalize">{$LL.utilityStatsOrdersIncrease()}</p>
			</div>
		</div>
		<div
			class="border border-white flex p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-black dark:text-white"
		>
			...
			<div class="flex flex-col justify-center align-middle">
				<p class="text-3xl font-semibold leadi">{$LL.utilityStatsEngagementIncreaseValue()}</p>
				<p class="capitalize">{$LL.utilityStatsEngagementIncrease()}</p>
			</div>
		</div>
		<div
			class="border border-white flex p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-black dark:text-white"
		>
			...
			<div class="flex flex-col justify-center align-middle">
				<p class="text-3xl font-semibold leadi">{$LL.utilityStatsConversionRateValue()}</p>
				<p class="capitalize">{$LL.utilityStatsConversionRate()}</p>
			</div>
		</div>
	</div>
</section>
